...
function CarrouselList(props) {
    ...
    return ( isLoaded && active ?
        <div id="carrousellist" style={props.style}>
            <img alt="left" className="arrow arrow-left" style={{marginLeft: '3vw'}} src={`${process.env.PUBLIC_URL}/arrow_left.png`} value='left' onClick={click} />
            ...
            <img alt="right" className="arrow arrow-right" style={{marginRight: '3vw'}} src={`${process.env.PUBLIC_URL}/arrow_right.png`} value='right' onClick={click} />
        </div> : null
    )
}
